...
class Worksheet
{
     ...
     */
    public function getListFeed($queryString = '')
    {
        $queryString = $queryString ? '?sq='. rawurldecode($queryString) : '';
        $res = ServiceRequestFactory::getInstance()->get($this->getListFeedUrl() . $queryString);
